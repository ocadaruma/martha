...
object TuneGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // Unity.unity2pixel(60) / 60
    val score = new SingleLineScore(Rect(0, 0, 1000000, 0), SingleLineScoreLayout.default.copy(widthPerUnitNoteLength = 100) * 3543.3071f)
    score.loadVoice(tune.tuneHeader, tune.tuneBody.voices(0))
